	...
	<div id="topbar">
		...
		<div class="fl_right">
			<p><? echo $_SESSION['sPersonaVS']; ?>&nbsp;&nbsp;&nbsp;
				<a onclick="sesionCerrar();" class="boton icon salir">Cerrar sesi&oacute;n </a></p></div>
		<br class="clear" />
	</div>
</div>
<!-- ####################################################################################################### -->
	...
	<div id="topnav">
		<div id='jqxMenu_Index'>
			<ul>
				<li>Registro
					<ul>
						<li id="vtaRevisionDocumentos">Revisi&oacute;n de documentos</li>
					</ul>
				</li>
			</ul>
		</div>
...
<div class="wrapper">
	<div id="breadcrumb">
		<ul class="animated fadeIn">
			<li class="first">M&oacute;dulo: Secretario Acad&eacute;mico</li>
		</ul>
	</div>
</div>
<!-- ####################################################################################################### -->
