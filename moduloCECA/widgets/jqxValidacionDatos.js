function datos_ValidacionDatos_Cargar(pCicloEstimulo) {
    ...
    for (var i = 0; i < 200; i++) {
        ...
        row["numeroMultimedios"] = numeroMultimedios;
    ...
    var source =
    {
        ...
        datafields: [
            ...
            {name: 'tipo', type: 'varchar'},
            {name: 'envioSolicitud', type: 'varchar'},
            {name: 'numeroMultimedios', type: 'int'}
        ]
    };
...
function Docentes_ValidacionDatos_TablaCargar(sControl, piCicloEstimuloID) {
    ...
    $(sControl).jqxGrid({
        ...
        columns: [
            ...
            {text: 'Tipo', datafield: 'tipo',cellsalign: 'center', editable: false, width: '161px', cellsrenderer: cellsrenderer},
            ...
            {text: 'No. multimedios educativos elaborados', datafield: 'numeroMultimedios', width: '269px', cellsalign: 'center', columntype: 'numberinput', cellsrenderer: cellsrenderer,
