...
<head>
	...
	<script type="text/javascript" src="/generalesDIyS/_jscript/jqwidgets_3.9.1/jqxcombobox.js"></script>
	<script type="text/javascript" src="/generalesDIyS/_jscript/jqwidgets_3.9.1/jqxwindow.js"></script>
...
<div class="wrapper">
	<div id="breadcrumb">
		<ul class="animated fadeIn">
			<li class="first">M&oacute;dulo: Parque Cient&iacute;fico y Tecnol&oacute;gico</li>
		</ul>
	</div>
</div>
<!-- ####################################################################################################### -->
