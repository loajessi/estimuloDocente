...
<head>
	...
	<link rel="stylesheet" href="../_estilo/especificos.css" type="text/css" />
	...
	<!-- Librerias -->
	<script type="text/javascript" src="/generalesDIyS/_jscript/jquery-1.11.1.min.js"></script>
...
<div class="wrapper">
	<div id="breadcrumb">
		<ul class="animated fadeIn">
			<li class="first">M&oacute;dulo: Centro de C&oacute;mputo Acad&eacute;mico</li>
		</ul>
	</div>
</div>
<!-- ####################################################################################################### -->
